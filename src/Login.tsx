  ...
  return (
    <div className="login">
      <div className="login__container">
        ...
        <hr />
        <button type="button" className="login__withApple" onClick={() => signIn(appleProvider)}>
          <div>
            <svg
        ...
        <button type="button" className="login__withGoogle" onClick={() => signIn(googleProvider)}>
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
